...
const Navbar = () => {
  ...
  const socialLinks = [
    {
      href: "https://www.facebook.com/share/1BcvWgVqNb/",
      icon: <BsFacebook />,
      key: "facebook",
    },
    {
      href: "https://www.instagram.com/edukaro_india?igsh=aHAwbnFiNGxlZnQ0 ",
      icon: <BsInstagram />,
      key: "instagram",
    },
  ];
  ...
  return (
    <div>
      <nav className="hidden md:block w-full absolute top-0 z-40 bg-[#dccce1]">
