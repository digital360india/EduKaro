        ...
        <div className="relative rounded px-3 p-4 space-y-6 border-r border-[#02618f60] last:border-none">
          <div className="flex justify-center">
            <div className="relative mt-4 w-full h-[170px] flex items-center justify-center">
              <img
                src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1733290846/EduKaro/${location}/H-${schooldetail.Image_Code}.png`}
                className="w-full h-[160px] rounded-md border p-2"
              />
              <button
                onClick={handleCancel}
                className="absolute top-0 right-0  bg-background-dark text-white hover:text-white rounded-full p-1 hover:bg-background-light"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
