...
const renderRow = (title, data1, data2, data3, data4) => (
  <tr className="border border-[#0C263F]">
    <td className="w-72 border border-background-dark py-2 px-4 font-semibold">
      {title}
    </td>
    <td
      className={`border border-[#0C263F] w-[300px] py-2 px-4 ${
  ...
  return (
    <>
      <div className="container mx-auto  py-8 ">
        ...
        <table className="w-full border border-collapse border-[#0C263F] ">
          <tbody>
            {renderRow(
              "Type of School",
      ...
      <div className="container mx-auto  py-8">
        ...
        <table className="w-full border-collapse border-[#0C263F]">
          <tbody>
            {renderRow(
              "Minimum Fees",
              schoolData1?.feefrom || "",
