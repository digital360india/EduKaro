      ...
      <section className=" sm:hidden    gap-8 overflow-scroll md:overflow-hidden mt-10 px-5">
        ...
        >
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1733290846/EduKaro/${city}/G-${school?.Image_Code}.png`}
          ...
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1733290846/EduKaro/${city}/H-${school?.Image_Code}.png`}
              className="w-[400px] h-[333px] rounded-3xl"
            />
            <div className="min-h-10"></div>
          </SwiperSlide>
          <SwiperSlide className="">
            <img
              src={`https://res.cloudinary.com/eduminatti-com/image/upload/v1733290846/EduKaro/${city}/I-${school?.Image_Code}.png`}
              className="w-[400px] h-[333px] rounded-3xl"
            />
            <div className="min-h-10"></div>
          </SwiperSlide>
