        ...
        <div className=" flex flex-col sm:flex-row gap-2 sm:gap-0 text-[12px] text-[#323232] pb-4   md:p-6 ">
          <div className="flex  flex-col  sm:items-center lg:w-[25vw]       ">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-dehradun"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-mussoorie"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-shimla"
                }
              >
          ...
          <div className="flex  flex-col  sm:items-center lg:w-[25vw]       ">
            <div className="flex flex-col">
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-india"
                }
              >
          ...
          {/* <div className="lg:w-[25vw]     sm:flex sm:justify-center ">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-chandigarh"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-mumbai"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-faridabad"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-nainital"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-varanasi"
                }
              >
          ...
          {/* <div className="   flex  sm:justify-center lg:w-[25vw]">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-kolkata"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-udaipur"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-jaipur"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-panchgani"
                }
              >
              ...
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-sikar"
                }
              >
          ...
          <div className=" flex sm:justify-center sm:mt-0  lg:w-[27vw]">
            <div className="flex flex-col">
              <Link
                href={
                  "https://www.edukaro.com/category/boarding-schools-in-hyderabad"
                }
              >
                Boarding Schools in Hyderabad
              </Link>
              <Link
                href={"https://www.edukaro.com/category/boarding-schools-in-pune"}
              >
